...
Verbose.usedSpellEvents = {
    ...
    UNIT_SPELLCAST_SENT = { callback="OnUnitSpellcastSent", title="Sent", icon=icon, classic=true },
    UNIT_SPELLCAST_START = { callback="OnUnitSpellcastCommon", title="Start", icon=icon, classic=true },
    UNIT_SPELLCAST_CHANNEL_START = { callback="OnUnitSpellcastCommon", title="Channel stasrt", icon=icon, classic=true },
    UNIT_SPELLCAST_SUCCEEDED = { callback="OnUnitSpellcastEnd", title="Succeeded", icon=icon, classic=true },
    UNIT_SPELLCAST_FAILED = { callback="OnUnitSpellcastEnd", title="Failed", icon=icon, classic=true },
    UNIT_SPELLCAST_INTERRUPTED = { callback="OnUnitSpellcastEnd", title="Interrupted", icon=icon, classic=true },
    UNIT_SPELLCAST_STOP = { callback="OnUnitSpellcastEnd", title="Stop", icon=icon, classic=true },
    UNIT_SPELLCAST_CHANNEL_STOP = { callback="OnUnitSpellcastEnd", title="Channel stop", icon=icon, classic=true },
}
