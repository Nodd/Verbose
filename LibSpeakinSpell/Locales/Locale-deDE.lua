...
local L = AceLocale:NewLocale("Verbose", "deDE", false)
if not L then return end

Verbose:PrintLoading("Locales/Locale-deDE.lua")
...
-- "/Verbose" Befehle und Abkürzungen.
...
L["This is a list of all the detected spells, abilities, items, and procced effects which Verbose has seen you cast or receive recently."] = [[Dies ist eine Liste von allen Zaubern, Fähigkeiten, Items, Proc-Effekten und anderen Ereignissen, welche Speakinspell kürzlich automatisch erkannt hat.]]
...
L["Verbose Loaded"]	= "Verbose geladen."
...
L["General Settings for Verbose"] = "Allgemeine Einstellungen für Verbose."

L["Message Settings"] = "Nachrichteneinstellungen"
L["Create New..."] = "Erstelle neu..."
L["Verbose Help"] = "Verbose Hilfe"
...
L["Stop Verbose from announcing the selected spell or event"] = "Stoppe Ansagen für den angewählten Zauber/Fähigkeit oder das Ereignis."

L["Enable Automatic Verbose Event Announcements"] = "Aktiviere Verbose."
...
[[Aktiviere diese Funktion damit Verbose nur für dich sichtbar im Chat alle gewirkten Ereignisse anzeigt die Verbose automatisch erkennt.
...
L["Show Debugging Messages (verbose)"] = "Zeige ausführliche Verbose-Nachrichten zu Fehlersuche."
...
L["To prevent Verbose from speaking in the chat too often for this spell, you can set a cooldown for how many seconds must pass before Verbose will announce this spell again."] = [[
Um zu verhindern das Verbose für den ausgewählten Zauber/Fähigkeit oder Ereignis zu oft Sprüche in den Chat sendet kann eine Abklingzeit festgesetzt werden.

Damit kann man bestimmen, wieviele Sekunden vergangen sein müssen bis Verbose für diesen Zauber, die Fähigkeit oder das Ereignis erneut einen Spruch senden kann.]]
