...
local L = AceLocale:NewLocale("Verbose", "koKR", false)
if not L then return end

Verbose:PrintLoading("Locales/Locale-koKR.lua")
...
-- "/Verbose" prefix and abbreviations
L["speakinspell"] = "마법알림"
L["ss"] = "마법알림"
...
L["SPEAKINSPELL CHANNEL"]	= "혼자보기 (Verbose:)" -- Translation Kor 3.2.0.04 Complete
...
L["This is a list of all the detected spells, abilities, items, and procced effects which Verbose has seen you cast or receive recently."] = [[이것은 최근에 당신이 시전했거나 받았던 마법, 능력, 아이템 기타 등등 중 SpeakinSpell이 감지한 것들의 목록입니다.]]
...
L["Verbose Loaded"]	= "SpeakingSpell 메모리 탑재" -- Add Korean Translation Complete ==> None is Proper Korean Expression for "Loaded". So add word "memory"(Korean word "메모리"). "메모리 탑재" is similar expression "Loaded"
...
L["General Settings for Verbose"] = "SpeakinSpell에 대한 일반 설정"

L["Message Settings"] = "메세지 설정"
L["Create New..."] = "새로 만들기..."
L["Verbose Help"] = "Verbose 도움말"
...
L["Stop Verbose from announcing the selected spell or event"] = "선택한 마법 또는 이벤트 알림을 비활성화 한다"

L["Enable Automatic Verbose Event Announcements"] = "Verbose 활성화"
