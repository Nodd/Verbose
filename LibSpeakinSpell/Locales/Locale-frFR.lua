...
local L = AceLocale:NewLocale("Verbose", "frFR", false)
if not L then return end

Verbose:PrintLoading("Locales/Locale-frFR.lua")
...
L["1. About Verbose"] = "1. À propos de Verbose"
...
L["Click|r to toggle Verbose on/off"] = "Cliquez pour (dés-)activer Verbose"
L["Collect Speeches"] = "Récupérer les paroles"
L["Colors"] = "Couleurs"
L["Colors of Verbose's special chat channels."] = "Couleurs des canaux de discussion spéciaux de Verbose."
L["Colors used by Verbose"] = "Couleurs utilisées par Verbose"
...
L["Each of these packs contain new content which you might enjoy using in Verbose"] = "Chacun de ces packs contient du contenu nouveau que vous pourriez apprécier d'utiliser dans Verbose"
L["Edit"] = "Éditer"
...
L["General Settings for Verbose"] = "Paramètres généraux pour Verbose"
...
L["Share speeches and other data with other Verbose users"] = "Partager les paroles et autres données avec les autres utilisateurs de Verbose"
L["Share the speeches I have written for Verbose events"] = "Partager les paroles que j'ai écrites pour les évènements de Verbose"
...
L["all automated Verbose announcements are disabled (except for /ss macro events)"] = "toutes les annonces automatiques de Verbose sont désactivées (mis à part les évènements de macros /ss)"
L["c"] = "c"
L["caster"] = "caster"
